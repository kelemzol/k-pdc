...
/* package pdc-krunner-0.1.0.0 */
#define VERSION_pdc_krunner "0.1.0.0"
#define MIN_VERSION_pdc_krunner(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package hexpat-0.20.10 */
#define VERSION_hexpat "0.20.10"
#define MIN_VERSION_hexpat(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  20 || \
  (major1) == 0 && (major2) == 20 && (minor) <= 10)

/* package language-pdc-0.1.0.0 */
#define VERSION_language_pdc "0.1.0.0"
#define MIN_VERSION_language_pdc(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
...
#define CURRENT_COMPONENT_ID "pdc-krunner-0.1.0.0-B1fLxNE250H1XZGvEQIUKz"

#define CURRENT_PACKAGE_KEY "pdc-krunner-0.1.0.0-B1fLxNE250H1XZGvEQIUKz"
